...
## İndirgenmis veri seti (data.csv) kullanılarak geliştirilecek olan sınıflandırma modellerine hiper parametre optimizasyonu yapıldı.
...
# # print(classfier_LR.best_params_)   #{'C': 2, 'class_weight': {0: 1, 1: 1}, 'max_iter': 100, 'penalty': 'l2', 'solver': 'liblinear'}
# hyper_log_reg = LogisticRegression(C = 2, max_iter = 100, penalty = 'l2', solver = 'liblinear', class_weight = {0: 1, 1: 1})
...
# # print(classfier_RF.best_params_) # {'class_weight': None, 'criterion': 'entropy', 'max_depth': 10, 'max_features': 'auto', 'min_samples_leaf': 2, 'min_samples_split': 10}
...
# print(classfier_KNN.best_params_)  #{'n_neighbors': 7, 'p': 2, 'weights': 'uniform'}
