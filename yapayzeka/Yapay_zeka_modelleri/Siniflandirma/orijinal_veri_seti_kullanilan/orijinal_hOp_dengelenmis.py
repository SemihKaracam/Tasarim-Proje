...
## 7 farklı veri seti dengeleme yöntemi kullanılarak orijinal veri seti dengelendi.
...
hyper_LR = LogisticRegression(C = 4, max_iter = 100, penalty = 'l2', solver = 'liblinear', class_weight = {0: 1, 1: 1})
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_ros,y_train_ros)

# y_pred_ros = hyper_naive_bayes.predict(x_test_ros)
# print('\n\nEvaluation with RandomOverSampler:')
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_smote,y_train_smote)

# y_pred_smote = hyper_naive_bayes.predict(x_test_smote)
# print('\n\nEvaluation with SMOTE:')
# print("Classification report of Hyper optimized Naive Bayes:\n", classification_report(y_test_smote, y_pred_smote) )
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_adasyn,y_train_adasyn)

# y_pred_adasyn = hyper_naive_bayes.predict(x_test_adasyn)
# print('\n\nEvaluation with ADASYN:')
# print("Classification report of Hyper optimized Naive Bayes:\n", classification_report(y_test_adasyn, y_pred_adasyn) )
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_rus,y_train_rus)

# y_pred_rus = hyper_naive_bayes.predict(x_test_rus)
# print('\n\nEvaluation with RandomUnderSampler:')
# print("Classification report of Hyper optimized Naive Bayes:\n", classification_report(y_test_rus, y_pred_rus) )
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_nearMiss,y_train_nearMiss)

# y_pred_nearMiss = hyper_naive_bayes.predict(x_test_nearMiss)
# print('\n\nEvaluation with Near Miss Under-Sampling:')
# print("Classification report of Hyper optimized Naive Bayes:\n", classification_report(y_test_nearMiss, y_pred_nearMiss) )
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_smote_enn,y_train_smote_enn)

# y_pred_smote_enn_NB = hyper_naive_bayes.predict(x_test_smote_enn)
# print('\n\nEvaluation with SMOTEENN:')
...
# hyper_naive_bayes = GaussianNB(priors= None, var_smoothing= 1e-09)  
# hyper_naive_bayes.fit(x_train_smote_tomek,y_train_smote_tomek)

# y_pred_smote_tomek = hyper_naive_bayes.predict(x_test_smote_tomek)
# print('\n\nEvaluation with SMOTETomek:')
# print("Classification report of Hyper optimized Naive Bayes:\n", classification_report(y_test_smote_tomek, y_pred_smote_tomek) )
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_ros,y_train_ros)

# y_pred_ros = hyper_xgb.predict(x_test_ros)
# print('\n\nEvaluation with RandomOverSampler:')
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_smote,y_train_smote)

# y_pred_smote = hyper_xgb.predict(x_test_smote)
# print('\n\nEvaluation with SMOTE:')
# print("Classification report of Hyper optimized XGB:\n", classification_report(y_test_smote, y_pred_smote) )
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_adasyn,y_train_adasyn)

# y_pred_adasyn = hyper_xgb.predict(x_test_adasyn)
# print('\n\nEvaluation with ADASYN:')
# print("Classification report of Hyper optimized XGB:\n", classification_report(y_test_adasyn, y_pred_adasyn) )
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_rus,y_train_rus)

# y_pred_rus = hyper_xgb.predict(x_test_rus)
# print('\n\nEvaluation with RandomUnderSampler:')
# print("Classification report of Hyper optimized XGB:\n", classification_report(y_test_rus, y_pred_rus) )
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_nearMiss,y_train_nearMiss)

# y_pred_nearMiss = hyper_xgb.predict(x_test_nearMiss)
# print('\n\nEvaluation with Near Miss Under-Sampling:')
# print("Classification report of Hyper optimized XGB:\n", classification_report(y_test_nearMiss, y_pred_nearMiss) )
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_smote_enn,y_train_smote_enn)

# y_pred_smote_enn_XGB = hyper_xgb.predict(x_test_smote_enn)
# print('\n\nEvaluation with SMOTEENN:')
...
# hyper_xgb = XGBClassifier(learning_rate=0.01, n_estimators=25, max_depth=15,gamma=0.6, subsample=0.52,colsample_bytree=0.6,seed=27, 
#                      reg_lambda=2, booster='dart', colsample_bylevel=0.6, colsample_bynode=0.5) #Extreme Gradient Boost
# hyper_xgb.fit(x_train_smote_tomek,y_train_smote_tomek)

# y_pred_smote_tomek = hyper_xgb.predict(x_test_smote_tomek)
# print('\n\nEvaluation with SMOTETomek:')
# print("Classification report of Hyper optimized XGB:\n", classification_report(y_test_smote_tomek, y_pred_smote_tomek) )
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10)
# hyper_dec_tree.fit(x_train_ros,y_train_ros)

# y_pred_ros = hyper_dec_tree.predict(x_test_ros)
# print('\n\nEvaluation with RandomOverSampler:')
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10) 
# hyper_dec_tree.fit(x_train_smote,y_train_smote)

# y_pred_smote = hyper_dec_tree.predict(x_test_smote)
# print('\n\nEvaluation with SMOTE:')
# print("Classification report of Hyper optimized Decision Tree:\n", classification_report(y_test_smote, y_pred_smote) )
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10)
# hyper_dec_tree.fit(x_train_adasyn,y_train_adasyn)

# y_pred_adasyn = hyper_dec_tree.predict(x_test_adasyn)
# print('\n\nEvaluation with ADASYN:')
# print("Classification report of Hyper optimized Decision Tree:\n", classification_report(y_test_adasyn, y_pred_adasyn) )
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10) 
# hyper_dec_tree.fit(x_train_rus,y_train_rus)

# y_pred_rus = hyper_dec_tree.predict(x_test_rus)
# print('\n\nEvaluation with RandomUnderSampler:')
# print("Classification report of Hyper optimized Decision Tree:\n", classification_report(y_test_rus, y_pred_rus) )
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10) 
# hyper_dec_tree.fit(x_train_nearMiss,y_train_nearMiss)

# y_pred_nearMiss = hyper_dec_tree.predict(x_test_nearMiss)
# print('\n\nEvaluation with Near Miss Under-Sampling:')
# print("Classification report of Hyper optimized Decision Tree:\n", classification_report(y_test_nearMiss, y_pred_nearMiss) )
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10)
# hyper_dec_tree.fit(x_train_smote_enn,y_train_smote_enn)

# y_pred_smote_enn_DT = hyper_dec_tree.predict(x_test_smote_enn)
# print('\n\nEvaluation with SMOTEENN:')
...
# hyper_dec_tree = DecisionTreeClassifier(criterion = 'gini',max_depth = 5,max_features='auto', min_samples_leaf=2, min_samples_split=10) 
# hyper_dec_tree.fit(x_train_smote_tomek,y_train_smote_tomek)

# y_pred_smote_tomek = hyper_dec_tree.predict(x_test_smote_tomek)
# print('\n\nEvaluation with SMOTETomek:')
# print("Classification report of Hyper optimized Decision Tree:\n", classification_report(y_test_smote_tomek, y_pred_smote_tomek) )
...
# # Karmaşıklık matrisi
# print("Confussion matrix of SVM:")
# plt.figure(figsize=(8, 6))
# sns.heatmap(confusion_matrix(y_test_ros, y_pred_ros), annot=True, fmt="d", cmap="Blues")
# plt.xlabel('Tahmin Edilen Sınıf')
# plt.ylabel('Gerçek Sınıf')
